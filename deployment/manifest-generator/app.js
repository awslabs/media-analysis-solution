...
walkSync('../dist/web_site', _filelist);

for (let i = 0; i < _filelist.length; i++) {
    _manifest.files.push(_filelist[i].replace('../dist/web_site/', ''));
};

console.log(_manifest);
fs.writeFile('../dist/web-site-manifest.json', JSON.stringify(_manifest, null, 4));
